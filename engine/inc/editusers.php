...
<table width="99%">
    ...
    <tr>
        ...
        <td><input size="30" class="edit bk" name="editmail" value="{$row['email']}" /> <label class="checkbox-inline"><input class="icheck" type="checkbox" name="allow_mail" value="1" {$mailbox}>{$lang['no_mail']}</label></td>
    </tr>
    <tr>
        <td colspan="3"><hr></td>
    </tr>
    <tr>
        ...
        <td colspan="2"><input size="30" name="editlogin" class="edit bk"></td>
    </tr>
    <tr>
        <td style="padding:4px;">{$lang['user_newpass']}</td>
        <td colspan="2"><input size="30" name="editpass" class="edit bk"></td>
    </tr>
    <tr>
        <td colspan="3"><hr></td>
    </tr>
    ...
    <tr>
        ...
        <td colspan="2"><input data-rel="calendardatetime" type="text" size="30" name="time_limit" id="time_limit" class="edit bk" value="{$row['time_limit']}" autocomplete="off"></td>
    </tr>
    <tr>
        <td colspan="3"><hr></td>
    </tr>
...
<option value="3" $restricted_selected[3]>{$lang['restricted_all']}</option>
    ...
    <tr>
        ...
        <td colspan="2"><input size="30" name="gravatar" value="{$gravatar}" class="edit bk"></td>
    </tr>
    <tr>

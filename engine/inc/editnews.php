...
{$save_edit_alert}
	...
	if( $member_id['user_group'] == 1 ) {
		...
		$author_info = "<input type=\"text\" name=\"new_author\" class=\"form-control position-left\" style=\"width: 10rem;\" value=\"{$row['autor']}\"><input type=\"hidden\" name=\"old_author\" value=\"{$row['autor']}\" />";
                     ...
                     <div class="tab-pane active" id="tabhome">
						<div class="panel-body">
							...
							<div class="form-group">
							  ...
							  <div class="col-sm-10">
								<input type="text" name="newdate" data-rel="calendar" class="form-control position-left" style="width: 9rem;" value="{$row['date']}" autocomplete="off"><label class="checkbox-inline"><input class="icheck" type="checkbox" name="allow_now" id="allow_now" value="yes">{$lang['edit_jdate']}</label>
							  </div>
							 </div>

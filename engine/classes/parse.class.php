...
class ParseFilter {
	...
	function __construct($tagsArray = array()) {
		...
		if ( count($tagsArray) ) {
			...
			$parse_config->set('Attr.AllowedClasses', array("quote", "title_quote", "highslide", "fr-dib", "fr-dii", "fr-fir", "fr-draggable", "fr-fil", "fr-rounded", "fr-padded", "fr-bordered", "fr-shadows", "fr-strong", "fr-text-red", "fr-text-blue", "fr-text-green", "native-emoji", "contenteditable", "noncontenteditable", "quote_block", "quote_body", "language-markup", "language-javascript", "language-css", "language-php", "language-ruby", "language-python", "language-java", "language-c", "language-csharp", "language-cpp") );

...
jQuery(function($){
	...
	tinymce.init({
		...
		toolbar: 'bold italic underline strikethrough | align | bullist numlist | indent outdent | link dleleech | {$implugin} {$image_upload[0]} dletube dlemp dlaudio | dleemo | dle fontformatting textformatting | toc fullscreen code',

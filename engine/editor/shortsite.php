...
HTML;
	...
	tinymce.init({
		...
		toolbar: 'bold italic underline strikethrough | align | bullist numlist | link dleleech | {$implugin} {$image_upload[0]} dlemp dlaudio dletube dleemo | dle fontformatting textformatting | toc fullscreen code',

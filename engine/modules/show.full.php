...
if (typeof $.fn.plupload !== "function" ) {
	...
	$.getCachedScript(dle_root + 'engine/classes/uploads/html5/plupload/plupload.full.min.js').done(function() {
		$.getCachedScript(dle_root +'engine/classes/uploads/html5/plupload/plupload.ui.min.js').done(function() {
			$.getCachedScript(dle_root + 'engine/classes/uploads/html5/plupload/i18n/{$lang['wysiwyg_language']}.js').done(function() {
